...
//        print('selectedCamera : $selectedCameraIdx');

//        Permission.requestPermissions([PermissionName.Camera])
//            .then((permissions) {
//          print('permission : ${permissions[0].permissionStatus}');
...
//        Permission.getPermissionsStatus([PermissionName.Camera])
//            .then((permission) {
//          print(
//              '#45 permission ${permission[0].permissionName}, ${permission[0].permissionStatus}');
//
//        });
      }
    }).catchError((err) {
